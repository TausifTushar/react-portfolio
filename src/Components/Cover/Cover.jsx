      ...
      <div className=" flex justify-center items-center gap-52 text-white h-[90vh] bg-[#171327]">
        <div data-aos="fade-right">
          ...
          <div className="flex gap-5 mt-7">
            <h3
              data-aos="fade-down"
              className=" hover:shadow-custom hover:border-2 hover:border-fuchsia-600 hover:drop-shadow-2xl p-2 rounded-3xl text-fuchsia-600 text-3xl"
            >
              <a href="https://www.facebook.com/" target="_blank"><BsFacebook className="" /></a>
            </h3>
            <h3
              data-aos="fade-up"
              className=" hover:shadow-custom hover:border-2 hover:border-fuchsia-600 hover:shadow-3xl p-2 rounded-3xl text-fuchsia-600 text-3xl"
            >
             <a href="https://github.com/TausifTushar" target="_blank"> <BsGithub className="" /></a>
            </h3>
            <h3
              data-aos="fade-down"
              className=" hover:shadow-custom hover:border-2 hover:border-fuchsia-600 hover:shadow-3xl p-2 rounded-3xl text-fuchsia-600 text-3xl"
